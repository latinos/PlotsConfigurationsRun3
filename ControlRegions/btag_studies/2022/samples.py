...
samples['DY'] = {
    ...
    'weight': mcCommonWeight + "* 1.00538", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 10,
    }
...
samples['ttbar'] = {
    'name': files,
    #'weight': mcCommonWeight, # To use with fixed WP btag SFs
    'weight': mcCommonWeight + "* 0.98795", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 5,
}
...
samples['tW'] = {
    'name': files,
    #'weight': mcCommonWeight, # To use with fixed WP btag SFs
    'weight': mcCommonWeight + "* 0.992329", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 5,
}
...
samples['WW'] = {
    'name': files,
    #'weight': mcCommonWeight, # To use with fixed WP btag SFs
    'weight': mcCommonWeight + "* 0.996714", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 2,
}
...
samples['WZ'] = {
    'name': files,
    #'weight': mcCommonWeight, # To use with fixed WP btag SFs
    'weight': mcCommonWeight + "* 1.00246", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 2,
}
...
samples['ggH_hww'] = {
    'name': files,
    #'weight': mcCommonWeight, # To use with fixed WP btag SFs
    'weight': mcCommonWeight + "* 0.99423", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 2,
}
...
samples['qqH_hww'] = {
    'name': files,
    #'weight': mcCommonWeight, # To use with fixed WP btag SFs
    'weight': mcCommonWeight + "* 1.00114", # To use with shape correction SFs, the multiplicative factor is the ratio r, calculated with the macro btag_ratio.cc
    'FilesPerJob': 2,
}
