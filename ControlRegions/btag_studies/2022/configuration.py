...
outputFolder = "rootFiles/rootFiles__{}".format(tag)
...
aliasesFile = "aliases_fixedWP.py" # Use with fixed WP
#aliasesFile = "aliases_reshaping.py" # Use with reshaping
...
nuisancesFile = "nuisances_fixedWP.py" # Use with fixed WP
#nuisancesFile = "nuisances_reshaping.py" # Use with reshaping
