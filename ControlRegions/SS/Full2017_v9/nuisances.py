...
for channel in channels:
    my_list = [cut for cut in cuts if f'{channel}' in cut]
    print(f"Cuts with {channel} in them: {my_list}")
    ...
    for charge in charges:
        for channel in channels:
            ...
            nuisances[f'CMS_WH_hww_fake_syst_{jet_bin}_{channel}_{charge}']  = {
                'name'    : f'CMS_WH_hww_fake_syst_{jet_bin}_{channel}_{charge}_2017',
                'samples' : {
...
#                 'name'    : f'CMS_WH_hww_fake_syst_{eta_regime}_{pt_regime}_{channel}_2017',
#                 'samples' : {
#                     f'Fake_{channel}' : fake_syst_dict[f'{eta_regime}_{pt_regime}_pt'],
#                 },
#                 'type'    : 'shape',
#                 'cuts'    : [cut for cut in cuts if (f'{channel}' in cut)],
#             }
...
for flavor in flavors:
    for charge in charges:
        ...
        nuisances[f'CMS_WH_hww_fake_syst_{flavor}_{charge}']  = {
            'name'    : f'CMS_WH_hww_fake_syst_{flavor}_{charge}_2017',
            'samples' : {
                'Fake_em' : '1.30',
                'Fake_mm' : '1.30',
                'Fake_ee' : '1.30',
...
#                 'name'    : f'CMS_WH_hww_fake_syst_{eta_regime}_{pt_regime}_{flavor}_2017',
#                 'samples' : {
#                     f'Fake_em' : fake_syst_dict[f'{eta_regime}_{pt_regime}_pt'],
#                     f'Fake_ee' : fake_syst_dict[f'{eta_regime}_{pt_regime}_pt'],
#                     f'Fake_mm' : fake_syst_dict[f'{eta_regime}_{pt_regime}_pt'],
#                 },
#                 'type'    : 'shape',
#                 'cuts'    : [cut for cut in cuts if (f'{flavor}' in cut)],
#             }
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jee_plus_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jee_plus_lowpt_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jem_plus_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jem_plus_lowpt_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jmm_plus_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jmm_plus_lowpt_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jee_plus_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jee_plus_lowpt_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jem_plus_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jem_plus_lowpt_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jmm_plus_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jmm_plus_lowpt_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jee_minus_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jem_minus_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jem_minus_lowpt_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jmm_minus_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_2jmm_minus_lowpt_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jee_minus_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jee_minus_lowpt_2017',
#     'samples' : {
#         'Fake_ee' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jem_minus_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jem_minus_lowpt_2017',
#     'samples' : {
#         'Fake_em' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jmm_minus_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1jmm_minus_lowpt_2017',
#     'samples' : {
#         'Fake_mm' : '1.50',
#     },
#     'type' : 'lnN',
