#ifndef BDT_WH3L_OSSF_v9
#define BDT_WH3L_OSSF_v9
...
public:
  ...
  double operator() ( float WH3l_dphilllmet,
	...
	WH3l_ZVeto_      = WH3l_ZVeto;
	WH3l_mtlmet_1_   = WH3l_mtlmet[1];
	WH3l_mtlmet_2_   = WH3l_mtlmet[2];
...
BDT_WH3l_OSSF_v9::BDT_WH3l_OSSF_v9( TString BDT_name, TString xml_file_name ){
...
BDT_WH3l_OSSF_v9::~BDT_WH3l_OSSF_v9(){
...
// float BDT_WH3l_OSSF_v9(
// 					   TString BDT_name,
// 					   TString xml_file_name,
// 					   float WH3l_dphilllmet,
// 					   RVecF WH3l_mOSll,
// 					   RVecF WH3l_ptOSll,
// 					   RVecF WH3l_drOSll,
// 					   float WH3l_ZVeto,
