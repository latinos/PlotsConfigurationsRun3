...
public:
  ...
  float GetFR_1l( double pt1 , double eta1, double pdg1, double isTight1, TH2F* fake_rate_ele_, TH2F* fake_rate_muon_, TString stat);
  ...
  float operator()(RVecI Lepton_pdgId,
    ...
    if (nLeptons_ == 1){
      ...
      float fakeWeight_1l0j = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
									   fake_rate_ele_35_, fake_rate_muon_20_, "Nominal");
      
      float fakeWeight_1l1j = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
									   fake_rate_ele_35_, fake_rate_muon_25_, "Nominal");
      
      float fakeWeight_1l2j = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
									   fake_rate_ele_35_, fake_rate_muon_35_, "Nominal");
      
      float fakeWeight = fakeWeight_1l0j*( nCleanJet == 0 || CleanJet_pt[0] <  30) +
		                 fakeWeight_1l1j*((nCleanJet == 1 && CleanJet_pt[0] >= 30) ||
                                          (nCleanJet >  1 && CleanJet_pt[0] >= 30  && CleanJet_pt[1] < 30)) +
                         fakeWeight_1l2j*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
	  
      if (kind_ == "nominal") return fakeWeight;

      // Calculate the per-event fake rate - EleUp
      if (kind_ == "EleUp"){
        float fakeWeight_1l0jElUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											 fake_rate_ele_45_, fake_rate_muon_20_, "Nominal");
        
        float fakeWeight_1l1jElUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											 fake_rate_ele_45_, fake_rate_muon_25_, "Nominal");
        
        float fakeWeight_1l2jElUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											 fake_rate_ele_45_, fake_rate_muon_35_, "Nominal");
        
        float fakeWeightEleUp = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jElUp*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
			          fakeWeight_1l1jElUp*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
                                           (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
                      fakeWeight_1l2jElUp*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "EleDown"){
        float fakeWeight_1l0jElDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   fake_rate_ele_25_, fake_rate_muon_20_, "Nominal");
        
        float fakeWeight_1l1jElDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   fake_rate_ele_25_, fake_rate_muon_25_, "Nominal");
        
        float fakeWeight_1l2jElDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   fake_rate_ele_25_, fake_rate_muon_35_, "Nominal");
        
        float fakeWeightEleDown = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jElDown*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
                      fakeWeight_1l1jElDown*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
											 (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
          			  fakeWeight_1l2jElDown*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "MuUp"){
        float fakeWeight_1l0jMuUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											 fake_rate_ele_35_, fake_rate_muon_30_, "Nominal");
        
        float fakeWeight_1l1jMuUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											 fake_rate_ele_35_, fake_rate_muon_35_, "Nominal");
        
        float fakeWeight_1l2jMuUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											 fake_rate_ele_35_, fake_rate_muon_45_, "Nominal");
        
        float fakeWeightMuUp = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jMuUp*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
			          fakeWeight_1l1jMuUp*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
										   (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
                      fakeWeight_1l2jMuUp*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "MuDown"){
        float fakeWeight_1l0jMuDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   fake_rate_ele_35_, fake_rate_muon_10_, "Nominal");
        
        float fakeWeight_1l1jMuDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   fake_rate_ele_35_, fake_rate_muon_15_, "Nominal");
        
        float fakeWeight_1l2jMuDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   fake_rate_ele_35_, fake_rate_muon_25_, "Nominal");
        
        float fakeWeightMuDown = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jMuDown*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
			          fakeWeight_1l1jMuDown*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
											 (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
			          fakeWeight_1l2jMuDown*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "StatEleUp"){
        float fakeWeight_1l0jstatElUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 fake_rate_ele_35_, fake_rate_muon_20_, "ElUp");
        
        float fakeWeight_1l1jstatElUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 fake_rate_ele_35_, fake_rate_muon_25_, "ElUp");
        
        float fakeWeight_1l2jstatElUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 fake_rate_ele_35_, fake_rate_muon_35_, "ElUp");
        
        float fakeWeightstatEleUp = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jstatElUp*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
			          fakeWeight_1l1jstatElUp*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
											   (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
                      fakeWeight_1l2jstatElUp*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "StatEleDown"){
        float fakeWeight_1l0jstatElDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   fake_rate_ele_35_, fake_rate_muon_20_, "ElDown");
        
        float fakeWeight_1l1jstatElDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   fake_rate_ele_35_, fake_rate_muon_25_, "ElDown");
        
        float fakeWeight_1l2jstatElDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   fake_rate_ele_35_, fake_rate_muon_35_, "ElDown");
        
        float fakeWeightstatEleDown = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jstatElDown*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
			          fakeWeight_1l1jstatElDown*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
												 (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
			          fakeWeight_1l2jstatElDown*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "StatMuUp"){
        float fakeWeight_1l0jstatMuUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 fake_rate_ele_35_, fake_rate_muon_20_, "MuUp");
        
        float fakeWeight_1l1jstatMuUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 fake_rate_ele_35_, fake_rate_muon_25_, "MuUp");
        
        float fakeWeight_1l2jstatMuUp = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 fake_rate_ele_35_, fake_rate_muon_35_, "MuUp");
        
        float fakeWeightstatMuUp = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jstatMuUp*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
			          fakeWeight_1l1jstatMuUp*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
											   (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
                      fakeWeight_1l2jstatMuUp*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
      ...
      if (kind_ == "StatMuDown"){
        float fakeWeight_1l0jstatMuDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   fake_rate_ele_35_, fake_rate_muon_20_, "MuDown");
        
        float fakeWeight_1l1jstatMuDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   fake_rate_ele_35_, fake_rate_muon_25_, "MuDown");
        
        float fakeWeight_1l2jstatMuDown = GetFR_1l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   fake_rate_ele_35_, fake_rate_muon_35_, "MuDown");
        
        float fakeWeightstatMuDown = 0.;
        if (fakeWeight != 0.){
		  float num = fakeWeight_1l0jstatMuDown*( nCleanJet == 0 || CleanJet_pt[0] <  30) + 
                      fakeWeight_1l1jstatMuDown*((nCleanJet == 1 && CleanJet_pt[0] >= 30) || 
												 (nCleanJet >  1 && CleanJet_pt[0] >= 30 && CleanJet_pt[1] < 30)) + 
                      fakeWeight_1l2jstatMuDown*( nCleanJet >  1 && CleanJet_pt[1] >= 30);
...
// Get fake rate for 1-lepton events
// std::tuple<double,double>
float
fake_rate_reader::GetFR_1l( double pt1 , double eta1, double pdg1, double isTight1,
  ...
  if (isTight1 == 1){
    ++nTight;
    fake_probability1 = f1*(p1 - 1.) / (p1 - f1);
  }
  else{
    fake_probability1 = f1*p1 / (p1 - f1);
  }

  return fake_probability1;
}
