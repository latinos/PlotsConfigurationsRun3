...
for jet_bin in jet_bins:
    for channel in channels:
        for charge in charges:
            ...
            #             'name'    : f'CMS_WH_hww_fake_syst_{eta_regime}_{pt_regime}_{channel}_2016',
            #             'samples' : {
...
for flavor in flavors:
    for charge in charges:
        ...
        nuisances[f'CMS_WH_hww_fake_syst_{flavor}_{charge}']  = {
            'name'    : f'CMS_WH_hww_fake_syst_{flavor}_{charge}_2016',
            'samples' : {
                'Fake' : '1.30',
            },
            'type'    : 'lnN',
        ...
        #             'name'    : f'CMS_WH_hww_fake_syst_{eta_regime}_{pt_regime}_{flavor}_2016',
        #             'samples' : {
