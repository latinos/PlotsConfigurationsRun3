...
tag = "SS_2023BPixv12_newpostproc"   
...
outputFolder = "rootFiles/Control_Regions/SS_rerun/rootFiles__{}".format(tag)
...
plotPath = "Plots/Control_Regions/SS_rerun/{}".format(tag)
