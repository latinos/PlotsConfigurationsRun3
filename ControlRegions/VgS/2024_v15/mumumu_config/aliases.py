...
configurations = os.path.dirname(configurations) # <user folder>/PlotsConfigurationsRun3/ControlRegions/VgS/2024_v15/mumumu_config
...
LeadmuWP = 'cut_TightID_pfIsoTight_HWW_tthmva_67'
muWP  = 'cut_Tight_HWW'
# No MVA requirement for leptons 2 and 3. cut_TightID_pfIsoTight_HWW_tthmva_67 ID for the leading muon.
aliases['LepWPCut'] = {
    'expr' : "Lepton_isTightMuon_" + LeadmuWP + "[0]>0.5 && Lepton_isTightMuon_" + muWP + "[1]>0.5 && Lepton_isTightMuon_" + muWP + "[2]>0.5",
    'samples': mc + ['DATA'],
}

aliases['LepWPSF'] = {
    'expr' : "Lepton_tightMuon_" + LeadmuWP + "_IdIsoSF[0]*Lepton_tightMuon_" + muWP + "_IdIsoSF[1]*Lepton_tightMuon_" + muWP + "_IdIsoSF[2]",
    'samples': mc
}
