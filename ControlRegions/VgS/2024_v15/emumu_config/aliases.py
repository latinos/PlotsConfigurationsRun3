...
configurations = os.path.dirname(configurations) # <user folder>/PlotsConfigurationsRun3/ControlRegions/VgS/2024_v15/emumu_config
...
muWP  = 'cut_Tight_HWW'
# No MVA requirement for leptons 2 and 3. cutBased_MediumID_tthMVA_Run3 electrons ID for the electron (leading lepton).
aliases['LepWPCut'] = {
    'expr' : "Lepton_isTightElectron_" + eleWP + "[0]>0.5 && Lepton_isTightMuon_" + muWP + "[1]>0.5 && Lepton_isTightMuon_" + muWP + "[2]>0.5",
    'samples': mc + ['DATA'],
}

aliases['LepWPSF'] = {
    'expr' : "Lepton_tightElectron_" + eleWP + "_IdIsoSF[0]*Lepton_tightMuon_" + muWP + "_IdIsoSF[1]*Lepton_tightMuon_" + muWP + "_IdIsoSF[2]",
    'samples': mc
}
