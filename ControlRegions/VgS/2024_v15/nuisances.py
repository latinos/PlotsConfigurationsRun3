...
nuisances['QCDscale_top']  = {
    ...
    'type'  : 'shape',
    'samples' : {
        'top' : ['Alt(LHEScaleWeight,0, 1.)', 'Alt(LHEScaleWeight,nLHEScaleWeight-1,1)']
    }
}
...
nuisances['QCDscale_DY'] = {
    ...
    'type': 'shape',
    'samples': {
        'DY': ['Alt(LHEScaleWeight,0, 1.)', 'Alt(LHEScaleWeight,nLHEScaleWeight-1,1)']
    }
}
nuisances['QCDscale_VV'] = {
    ...
    'type' : 'shape',
    'samples' : {
        'WW'  : ['Alt(LHEScaleWeight,0, 1.)', 'Alt(LHEScaleWeight,nLHEScaleWeight-1,1)']
    }
}
