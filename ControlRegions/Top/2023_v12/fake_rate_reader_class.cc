...
fake_rate_reader::fake_rate_reader( TString year , TString ele_WP, TString muon_WP, float ele_WP_number, float muon_WP_number, TString kind, uint nLeptons, TString electron_tight_charge, TString mkShapesRDF_base, TString fakerate_version){
  ...
  TString fake_muon_file_name_10 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet10.root";
  TString fake_muon_file_name_15 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet15.root";
  TString fake_muon_file_name_20 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet20.root";
  TString fake_muon_file_name_25 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet25.root";
  TString fake_muon_file_name_30 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet30.root";
  TString fake_muon_file_name_35 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet35.root";
  TString fake_muon_file_name_45 = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonFR_jet45.root";
  ...
  TString fake_ele_file_name_25  = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cutBased_LooseID_tthMVA_Run3/EleFR_jet25.root";
  TString fake_ele_file_name_35  = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cutBased_LooseID_tthMVA_Run3/EleFR_jet35.root";
  TString fake_ele_file_name_45  = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cutBased_LooseID_tthMVA_Run3/EleFR_jet45.root";

  // Prompt rate input files
  TString pr_muon_file_name = "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cut_TightID_pfIsoTight_HWW_tthmva_67/MuonPR.root";
  if (year_ == "2016_HIPM" || year_ == "2016_noHIPM")
    pr_muon_file_name = mkShapesRDF_base + "/data/" + fakerate_version + "/" + year + "/cut_Tight80x_tthmva_" + muon_WP + "/MuonPR.root";
  TString pr_ele_file_name =  "/eos/user/s/squinto/FakeRate/2023_v12/FakeRate_2023_v12/cutBased_LooseID_tthMVA_Run3/ElePR.root";
