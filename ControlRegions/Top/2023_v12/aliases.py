...
aliases['fakeW'] = {
    'linesToAdd'     : [f'#include "/afs/cern.ch/user/s/squinto/private/work/PlotsConfigurationRun3/ControlRegions/Top/2023_v12/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader = fake_rate_reader(\"2023\", \"0\", \"0\", 0.0, 0.0, \"nominal\", 2, \"std\", \"{configurations}\", \"sns\");')"],
...
eff_map_year = '2023' # ['2022', '2022EE', '2023', '2023BPix']
