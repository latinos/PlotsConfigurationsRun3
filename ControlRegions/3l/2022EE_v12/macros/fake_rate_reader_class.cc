...
fake_rate_reader::fake_rate_reader( TString year , TString ele_WP, TString muon_WP, float ele_WP_number, float muon_WP_number, TString kind, uint nLeptons, TString electron_tight_charge, TString mkShapesRDF_base ){
  ...
  TString fake_muon_file_name_10 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet10.root";
  TString fake_muon_file_name_15 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet15.root";
  TString fake_muon_file_name_20 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet20.root";
  TString fake_muon_file_name_25 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet25.root";
  TString fake_muon_file_name_30 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet30.root";
  TString fake_muon_file_name_35 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet35.root";
  TString fake_muon_file_name_45 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet45.root";

  if (year_ == "2016_HIPM" || year_ == "2016_noHIPM"){
    fake_muon_file_name_10 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet10.root";
    fake_muon_file_name_15 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet15.root";
    fake_muon_file_name_20 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet20.root";
    fake_muon_file_name_25 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet25.root";
    fake_muon_file_name_30 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet30.root";
    fake_muon_file_name_35 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet35.root";
    fake_muon_file_name_45 = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonFR_jet45.root";
  }

  TString fake_ele_file_name_25  = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+ele_WP+"/EleFR_jet25.root";
  TString fake_ele_file_name_35  = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+ele_WP+"/EleFR_jet35.root";
  TString fake_ele_file_name_45  = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+ele_WP+"/EleFR_jet45.root";

  // Prompt rate input files
  TString pr_muon_file_name = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonPR.root";
  if (year_ == "2016_HIPM" || year_ == "2016_noHIPM")
    pr_muon_file_name = "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+muon_WP+"/MuonPR.root";
  TString pr_ele_file_name =  "/eos/user/s/squinto/FakeRate/2022EE_v12_conept/"+ele_WP+"/ElePR.root";
