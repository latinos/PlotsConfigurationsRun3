...
# /afs/cern.ch/user/n/ntrevisa/work/latinos/Run3/PlotsConfigurationsRun3/ControlRegions/3l/Full2017_v9/
...
# LepCut2l__ele_mvaFall17V2Iso_WP90__mu_cut_Tight_HWWW_tthmva_82
...
aliases['LepWPttHMVASF'] = {
    ...
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('ttHMVASF ttH = ttHMVASF(\"2017\", 3, \"all\", \"nominal\",\"{configurations}/WH_chargeAsymmetry/UL/data/\");')"],
...
aliases['LepWPttHMVASFEleUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/ttHMVASF_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('ttHMVASF ttH_EleUp = ttHMVASF(\"2017\", 3, \"all\", \"eleUp\" ,\"{configurations}/WH_chargeAsymmetry/UL/data/\");')"],
    'expr'           : 'ttH_EleUp(Lepton_pt, Lepton_eta, Lepton_pdgId)',
    'samples'        : mc
}
aliases['LepWPttHMVASFEleDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/ttHMVASF_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('ttHMVASF ttH_EleDown = ttHMVASF(\"2017\", 3, \"all\", \"eleDown\" ,\"{configurations}/WH_chargeAsymmetry/UL/data/\");')"],
...
aliases['LepWPttHMVASFMuUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/ttHMVASF_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('ttHMVASF ttH_MuUp = ttHMVASF(\"2017\", 3, \"all\", \"muUp\" ,\"{configurations}/WH_chargeAsymmetry/UL/data/\");')"],
    'expr'           : 'ttH_MuUp(Lepton_pt, Lepton_eta, Lepton_pdgId)',
    'samples'        : mc
}
aliases['LepWPttHMVASFMuDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/ttHMVASF_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('ttHMVASF ttH_MuDown = ttHMVASF(\"2017\", 3, \"all\", \"muDown\" ,\"{configurations}/WH_chargeAsymmetry/UL/data/\");')"],
...
aliases['fakeW'] = {
    ...
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"nominal\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWEleUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EleUp = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"EleUp\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWEleDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EleDown = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"EleDown\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWMuUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_MuUp = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"MuUp\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWMuDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_MuDown = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"MuDown\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWStatEleUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatEleUp = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"StatEleUp\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWStatEleDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatEleDown = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"StatEleDown\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWStatMuUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatMuUp = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"StatMuUp\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['fakeWStatMuDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/utils/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatMuDown = fake_rate_reader(\"2017\", \"90\", \"82\", 0.90, 0.82, \"StatMuDown\", 3, \"std\", \"{configurations}/ControlRegions/SS/\");')"],
...
aliases['BDT_WH3l_OSSF_new_v9'] = {
    ...
    'linesToProcess' : ["ROOT.gInterpreter.Declare('BDT_WH3l_OSSF_v9 BDT_WH3l_OSSF = BDT_WH3l_OSSF_v9(\"BDTG4C3\",\"{0}/ControlRegions/SS/data/BDT/2017/WH3l/OSSF/weights/TMVAClassification_BDTG4C3.weights.xml\");')".format(configurations)],
