...
aliases['fakeW'] = {
    ...
    'linesToProcess' : [f"ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader = fake_rate_reader(\"{eleWP}\", \"{muWP}\", \"nominal\", 3, \"std\", \"{fakerates}\", \"2023_v12_pt\");')"],
...
eff_map_year = '2023' # ['2022', '2022EE', '2023', '2023BPix', '2024']
