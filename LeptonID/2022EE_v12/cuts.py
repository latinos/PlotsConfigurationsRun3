...
#############################
# Applying TTHMVA selection #
#############################

# Muon ID: Tight ID POG
# Ele  ID: wp90iso
cuts['sr_ele_wp90iso__mu_cut_TightID_POG_tthmva_80'] = {
    'expr' : 'LepWPCut__ele_wp90iso__mu_cut_TightID_POG_tthmva_80 > 0.5',
    'categories' : {
        'ee_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] >= 20',
        'ee_low_pt'  : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] <  20',
        'em_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && Lepton_pt[1] >= 20',
...
# Muon ID: Tight HWW
# Ele  ID: mvaWinter22V2Iso_WP90
cuts['sr_ele_mvaWinter22V2Iso_WP90__mu_cut_Tight_HWW_tthmva_80'] = {
    'expr' : 'LepWPCut__ele_mvaWinter22V2Iso_WP90__mu_cut_Tight_HWW_tthmva_80 > 0.5',
    'categories' : {
        'ee_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] >= 20',
        'ee_low_pt'  : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] <  20',
        'em_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && Lepton_pt[1] >= 20',
...
# Muon ID: Tight ID MiniIso HWW
# Ele  ID: mvaWinter22V2Iso_WP90
cuts['sr_ele_mvaWinter22V2Iso_WP90__mu_cut_TightMiniIso_HWW_tthmva_80'] = {
    'expr' : 'LepWPCut__ele_mvaWinter22V2Iso_WP90__mu_cut_TightMiniIso_HWW_tthmva_80 > 0.5',
    'categories' : {
        'ee_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] >= 20',
        'ee_low_pt'  : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] <  20',
        'em_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && Lepton_pt[1] >= 20',
...
# Muon ID: mvaMuID WP tight HWW
# Ele  ID: wp90iso
cuts['sr_ele_wp90iso__mu_mvaMuID_WP_tight_tthmva_80'] = {
    'expr' : 'LepCut2l__ele_wp90iso__mu_mvaMuID_WP_tight_tthmva_80 > 0.5',
    'categories' : {
        'ee_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] >= 20',
        'ee_low_pt'  : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] <  20',
        'em_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && Lepton_pt[1] >= 20',
...
# Muon ID: mvaMuID WP medium HWW
# Ele  ID: wp90iso
cuts['sr_ele_wp90iso__mu_mvaMuID_WP_medium_tthmva_80'] = {
    'expr' : 'LepCut2l__ele_wp90iso__mu_mvaMuID_WP_medium_tthmva_80 > 0.5',
    'categories' : {
        'ee_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] >= 20',
        'ee_low_pt'  : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*11 && Lepton_pt[1] <  20',
        'em_high_pt' : 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && Lepton_pt[1] >= 20',
