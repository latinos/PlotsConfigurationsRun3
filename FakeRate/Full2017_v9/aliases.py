...
# /afs/cern.ch/user/n/ntrevisa/work/latinos/Run3/PlotsConfigurationsRun3/FakeRate/Full2017_v9
...
aliases['Lepton_mvaTTH_UL'] = {
    ...
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('ttH_MVA_reader ttHMVA = ttH_MVA_reader(\"BDTG\",\"{configurations}/data/UL20_el_TTH-like_2017_BDTG.weights.xml\",\"BDTG\",\"{configurations}/data/UL20_mu_TTH-like_2017_BDTG.weights.xml\");')"],
