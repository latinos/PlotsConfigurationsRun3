...
# DATA: /eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Run2016_UL2016_nAODv9_noHIPM_Full2016v9/DATAl1loose2016v9/
...
lumi_ele_low_pt   =  '3.980*(HLT_Ele12_CaloIdL_TrackIdL_IsoVL_PFJet30 > 0.5)*(Lepton_pt[0]<=25)';
lumi_ele_high_pt  = '10.699*(HLT_Ele23_CaloIdL_TrackIdL_IsoVL_PFJet30 > 0.5)*(Lepton_pt[0]>25)';
lumi_muon_low_pt  =  '1.297*(HLT_Mu8_TrkIsoVVL > 0.5)*(Lepton_pt[0]<=20)';
lumi_muon_high_pt = '26.873*(HLT_Mu17_TrkIsoVVL > 0.5)*(Lepton_pt[0]>20)';
lumi_full_2018    = '16812'
