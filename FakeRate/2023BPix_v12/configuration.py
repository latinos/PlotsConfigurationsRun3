...
tag = "2023BPixv12_cutBased_LooseID_tthMVA_Run3__mu_cut_TightID_pfIsoTight_HWW_tthmva_67"   
...
outputFolder = "rootFiles/FakeRate/2023BPixv12/rootFiles__{}".format(tag)
...
plotPath = "Plots/FakeRate/{}".format(tag)
