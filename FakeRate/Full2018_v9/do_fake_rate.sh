...
# Electrons
python mkFakeRate.py --inputFile /eos/user/n/ntrevisa/mkShapesRDF_rootfiles/Fake_Full2018_v9/rootFile/mkShapes__Fake_Full2018_v9.root --outputFile ../Full2018_v9/EleFR_45.root --jet_pt 45 --flavor ele --variable pt2_eta2 --do_prompt_rate True --outputFilePR ../Full2018_v9/ElectronPR.root
