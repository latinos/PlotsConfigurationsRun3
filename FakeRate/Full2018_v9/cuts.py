...
cuts['Zpeak_PR_loose'] = {
    'expr'       : 'nLepton>1 && (Lepton_pt[0]>25 || (abs(Lepton_pdgId[0]) == 11 && Lepton_pt[0]>33)) && LepWPCut1l && Lepton_pt[1]>10 && mll>76 && mll<106 && PuppiMET_pt<20',
    'categories' : {
...
# Prompt rate selections
cuts['Zpeak_PR_tight'] = {
    'expr'       : 'nLepton>1 && (Lepton_pt[0]>25 || (abs(Lepton_pdgId[0]) == 11 && Lepton_pt[0]>33)) && Lepton_pt[1]>10 && LepWPCut2l && mll>76 && mll<106 && PuppiMET_pt<20',
    'categories' : {
        'ele'  : 'Lepton_pdgId[0]*Lepton_pdgId[1] == -121',
        'muon' : 'Lepton_pdgId[0]*Lepton_pdgId[1] == -169',
    }
