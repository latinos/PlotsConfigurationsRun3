...
jes_sources = ['Absolute_2023','Absolute','BBEC1_2023','BBEC1','EC2_2023','EC2','FlavorQCD','HF_2023','HF','RelativeBal','RelativeSample_2023']
...
nuisances['eff_e'] = {
    ...
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, ['SFweightEleUp', '1/SFweightEleDown']) for skey in mc), #TODO: IN THIS SAMPLES THERE'S AN ERROR AND SFUP AND SFDO ARE THE SAME, NEEDS TO BE FIXED
}
