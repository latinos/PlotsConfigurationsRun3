...
public:
  ...
  fake_rate_reader( TString ele_WP, TString muon_WP, TString kind, uint nLeptons, TString electron_tight_charge, TString mkShapesRDF_base, TString year );
  ...
  float operator()(RVecI Lepton_pdgId,
    ...
    if (nLeptons_ == 2){
	  ...
	  // Use the same jet pT thresholds for all jet bins: 30 GeV
      float fakeWeight = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
      ...
      if (kind_ == "EleUp"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Raise jet pT threshold to 40 GeV for electrons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
      ...
      if (kind_ == "EleDown"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Lower jet pT threshold to 20 GeV for electrons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
      ...
      if (kind_ == "MuUp"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Raise jet pT threshold to 40 GeV for muons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
      ...
      if (kind_ == "MuDown"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Lower jet pT threshold to 20 GeV for muons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
      ...
      if (kind_ == "StatEleUp"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Use nominal jet pT thresholds but use upper stat variation for electrons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
							   fake_rate_ele_30_, fake_rate_muon_30_, "EleUp");
      ...
      if (kind_ == "StatEleDown"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Use nominal jet pT thresholds but use lower stat variation for electrons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
							   fake_rate_ele_30_, fake_rate_muon_30_, "EleDown");
      ...
      if (kind_ == "StatMuUp"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Use nominal jet pT thresholds but use upper stat variation for muons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
      ...
      if (kind_ == "StatMuDown"){
        ...
        if (fakeWeight != 0.){
		  ...
		  // Use nominal jet pT thresholds but use lower stat variation for muons
		  float num = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
							   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
...
fake_rate_reader::fake_rate_reader( TString ele_WP,
									TString muon_WP,
									TString kind,
									uint    nLeptons,
  ...
  cout << "Fake rates directory: " << mkShapesRDF_base << endl;
  cout << "Year:                 " << year << endl;
  ...
  kind_             = kind;
  nLeptons_         = nLeptons;
  mkShapesRDF_base_ = mkShapesRDF_base;
  year_             = year; 

  // Fake rate input files
  TString fake_muon_file_name_20 = mkShapesRDF_base_ + "/" + year_ + "/" + muon_WP + "/MuonFR_jet20.root";
  TString fake_muon_file_name_30 = mkShapesRDF_base_ + "/" + year_ + "/" + muon_WP + "/MuonFR_jet30.root";
  TString fake_muon_file_name_40 = mkShapesRDF_base_ + "/" + year_ + "/" + muon_WP + "/MuonFR_jet40.root";

  TString fake_ele_file_name_20  = mkShapesRDF_base_ + "/" + year_ + "/" + ele_WP  + "/EleFR_jet20.root";
  TString fake_ele_file_name_30  = mkShapesRDF_base_ + "/" + year_ + "/" + ele_WP  + "/EleFR_jet30.root";
  TString fake_ele_file_name_40  = mkShapesRDF_base_ + "/" + year_ + "/" + ele_WP  + "/EleFR_jet40.root";

  // Prompt rate input files
  TString pr_muon_file_name = mkShapesRDF_base_  + "/" + year_ + "/" + muon_WP + "/MuonPR.root";
  TString pr_ele_file_name  =  mkShapesRDF_base_ + "/" + year_ + "/" + ele_WP  + "/ElePR.root";
