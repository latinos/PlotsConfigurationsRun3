...
nuisances['fake_ele_stat'] = {
    'name': 'CMS_fake_stat_e_2016noHIPM',
    'skipCMS' : 1,
    'kind': 'weight',
    'type': 'shape',
    'samples': {
...
nuisances['fake_mu_stat'] = {
    'name': 'CMS_fake_stat_m_2016noHIPM',
    'skipCMS' : 1,
    'kind': 'weight',
    'type': 'shape',
    'samples': {
...
nuisances['trigg'] = {
    'name': 'CMS_eff_hwwtrigger_2016noHIPM',
    'skipCMS' : 1,
    'kind': 'weight',
    'type': 'shape',
...
nuisances['PS_ISR']  = {
    ...
    'samples': {
        ...
        'ZH_hww' : ['1.0008198940532742*(nCleanGenJet==0) + 1.001574300159756*(nCleanGenJet==1) + 1.0014892423703352*(nCleanGenJet==2) + 0.9982835923429388*(nCleanGenJet>=3)', '0.9991322211949244*(nCleanGenJet==0) + 0.9979828392772856*(nCleanGenJet==1) + 0.9980190791034156*(nCleanGenJet==2) + 1.0021025907582016*(nCleanGenJet>=3)'],
