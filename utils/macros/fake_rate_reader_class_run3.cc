...
public:
  ...
  fake_rate_reader( TString ele_WP, TString muon_WP, TString kind, uint nLeptons, TString electron_tight_charge, TString mkShapesRDF_base );
...
fake_rate_reader::fake_rate_reader( TString ele_WP,
  ...
  TString fake_muon_file_name_20 = mkShapesRDF_base_ + "/" + muon_WP + "/MuonFR_jet20.root";
  TString fake_muon_file_name_30 = mkShapesRDF_base_ + "/" + muon_WP + "/MuonFR_jet30.root";
  TString fake_muon_file_name_40 = mkShapesRDF_base_ + "/" + muon_WP + "/MuonFR_jet40.root";

  TString fake_ele_file_name_20  = mkShapesRDF_base_ + "/" + ele_WP  + "/EleFR_jet20.root";
  TString fake_ele_file_name_30  = mkShapesRDF_base_ + "/" + ele_WP  + "/EleFR_jet30.root";
  TString fake_ele_file_name_40  = mkShapesRDF_base_ + "/" + ele_WP  + "/EleFR_jet40.root";

  // Prompt rate input files
  TString pr_muon_file_name = mkShapesRDF_base_ + "/" + muon_WP + "/MuonPR.root";
  TString pr_ele_file_name  = mkShapesRDF_base_ + "/" + ele_WP  + "/ElePR.root";
