...
cuts0j = [k for k in _mergedCuts if '0j' in k]
cuts1j = [k for k in _mergedCuts if '1j' in k]
cuts2j = [k for k in _mergedCuts if '2j' in k]
...
nuisances['lumi_Uncorrelated'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.015') for skey in mc if skey not in ['WW', 'top',  'dytt'])
}
...
nuisances['lumi_LScale'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.002') for skey in mc if skey not in ['WW', 'top',  'dytt'])
}
...
for shift in ['jes', 'lf', 'hf', 'hfstats1', 'hfstats2', 'lfstats1', 'lfstats2', 'cferr1', 'cferr2']:
    ...
    nuisances['btag_shape_%s' % shift] = {
        ...
        'kind': 'weight',
        'type': 'shape',
        'samples': dict((skey, btag_syst) for skey in mcNoRPV),
    }
...
nuisances['trigg'] = {
    ...
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, trig_syst) for skey in mcNoRPV)
}
...
nuisances['eff_e'] = {
    ...
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, ['SFweightEleUp', 'SFweightEleDown']) for skey in mcNoRPV)
}
...
nuisances['electronpt'] = {
    ...
    'mapUp': 'ElepTup',
    'mapDown': 'ElepTdo',
    'samples': dict((skey, ['1', '1']) for skey in mcNoRPV),
...
nuisances['eff_m'] = {
    ...
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, ['SFweightMuUp', 'SFweightMuDown']) for skey in mcNoRPV)
}
...
nuisances['jetPUID'] = {
    ...
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, puid_syst) for skey in mcNoRPV)
}
