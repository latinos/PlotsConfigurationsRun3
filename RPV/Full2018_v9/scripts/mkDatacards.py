    ...
    def makeDatacards(
        ...
        for cutName in cuts:
            ...
            for variableName, variable in variables.items():
                ...
                if (self._parametric):
                    templateHisto = self._getHisto(cutName, variableName, list(samples.keys())[0])
                ...
                for snameList, yields in [
                    ...
                    for sampleName in snameList:
                        if 'parametric' in structureFile[sampleName]: continue
...
"""
    ...
    parser.add_option(
        '--isParametric', 
        dest='isParametric', 
        help="Set to True in case of parametric datacards", 
        default=False, 
        action='store_true',
    )
    ...
    factory.makeDatacards(
        inputFile, opt.outputDirDatacard, variables, cuts, samples, structure, nuisances, opt.isParametric
    )
