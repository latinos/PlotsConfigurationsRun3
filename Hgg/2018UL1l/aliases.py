...
#
mc_special = [skey for skey in samples if skey not in ('Fake', 'DATA', 'Hgluglu', 'qqZHgluglu', 'ggZHgluglu', 'WHgluglu')]
...
aliases['btagSF'] = {
    ...
    'expr': '(bVeto)*bVetoSF + (!bVeto)*bReqSF',
    #'samples': mc
    'samples' : mc_special
}
...
# aliases['SFweight'] = {
    ...
    # 'expr': ' * '.join(['SFweight1l', 'LepWPCut', 'LepWPSF','Jet_PUIDSF', 'btagSF']),
    # #'samples': mc
    # 'samples' : mc_special
# }
