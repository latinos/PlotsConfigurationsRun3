# Configuration file for charge asymmetry WHSS analysis using the UL 2016noHIPM dataset

import sys,inspect

# /afs/cern.ch/user/n/ntrevisa/work/latinos/Run3/PlotsConfigurationsRun3/WH_chargeAsymmetry/UL/2016noHIPM_v9/WHSS/configuration_2j_mm_CR

configurations_nuisance = os.path.realpath(inspect.getfile(inspect.currentframe())) # this file
configurations_nuisance = os.path.dirname(configurations_nuisance) # configuration_2j_mm_CR
...
# Output file name
outputFile = "plots_WHSS_2016noHIPM_v9_chargeAsymmetry_Mu82_EleUL90_DYflip_data.root" # "mkShapes__{}.root".format(tag)
