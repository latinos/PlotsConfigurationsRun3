...
if [ "$DATE" != "" ]; then
	...
	cp -r plots_WHSS_2016noHIPM_v9_chargeAsymmetry_Mu82_EleUL90/ /eos/user/n/ntrevisa/www/plots/WH_charge_asymmetry/${DATE}/2016noHIPM/
	cp /eos/user/n/ntrevisa/mkShapesRDF_rootfiles/WHSS_2016noHIPM_v9_chargeAsymmetry_Mu82_EleUL90/rootFile/plots_WHSS_2016noHIPM_v9_chargeAsymmetry_Mu82_EleUL90_DYflip_data.root /eos/user/n/ntrevisa/www/plots/WH_charge_asymmetry/${DATE}/2016noHIPM/
	echo "Done!"
fi
