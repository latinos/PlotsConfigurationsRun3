...
then
  ...
  echo "bash do_diagnostics_unblind.sh FullRun2_high_pt"
  echo ""
  echo "bash do_diagnostics_unblind.sh Full2018_high_pt"
  echo "bash do_diagnostics_unblind.sh 2018_WHSS_high_pt"
  echo "bash do_diagnostics_unblind.sh 2018_WH3l"
  echo ""
  echo "bash do_diagnostics_unblind.sh Full2017_high_pt"
  echo "bash do_diagnostics_unblind.sh 2017_WHSS_high_pt"
  echo "bash do_diagnostics_unblind.sh 2017_WH3l"
  echo ""
  echo "bash do_diagnostics_unblind.sh 2016noHIPM_high_pt"
  echo "bash do_diagnostics_unblind.sh 2016noHIPM_WHSS_high_pt"
  echo "bash do_diagnostics_unblind.sh 2016noHIPM_WH3l"
  echo ""
  echo "bash do_diagnostics_unblind.sh 2016HIPM_high_pt"
  echo "bash do_diagnostics_unblind.sh 2016HIPM_WHSS_high_pt"
  echo "bash do_diagnostics_unblind.sh 2016HIPM_WH3l"
  exit 1
else
...
if [ $FINAL_STATE == FullRun2_high_pt ]; then
	...
	python3 ../scripts/script_workspace_and_fit_unblind.py \
			...
			--freeze_nuisances r_higgs --sanity_check FD_WH_strength
