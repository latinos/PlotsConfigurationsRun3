...
public:
  ...
  TH2F* fake_rate_muon_10EWKUp_;   
  TH2F* fake_rate_muon_15EWKUp_;   
  TH2F* fake_rate_muon_20EWKUp_;   
  TH2F* fake_rate_muon_25EWKUp_;   
  TH2F* fake_rate_muon_30EWKUp_;   
  TH2F* fake_rate_muon_35EWKUp_;   
  TH2F* fake_rate_muon_40EWKUp_;   
  TH2F* fake_rate_muon_45EWKUp_;   
  TH2F* fake_rate_muon_10EWKDown_; 
  TH2F* fake_rate_muon_15EWKDown_; 
  TH2F* fake_rate_muon_20EWKDown_; 
  TH2F* fake_rate_muon_25EWKDown_; 
  TH2F* fake_rate_muon_30EWKDown_; 
  TH2F* fake_rate_muon_35EWKDown_; 
  TH2F* fake_rate_muon_40EWKDown_; 
  TH2F* fake_rate_muon_45EWKDown_; 
  ...
  TH2F* fake_rate_ele_20EWKUp_;    
  TH2F* fake_rate_ele_25EWKUp_;    
  TH2F* fake_rate_ele_30EWKUp_;    
  TH2F* fake_rate_ele_35EWKUp_;    
  TH2F* fake_rate_ele_40EWKUp_;    
  TH2F* fake_rate_ele_45EWKUp_;    
  TH2F* fake_rate_ele_20EWKDown_;  
  TH2F* fake_rate_ele_25EWKDown_;  
  TH2F* fake_rate_ele_30EWKDown_;  
  TH2F* fake_rate_ele_35EWKDown_;  
  TH2F* fake_rate_ele_40EWKDown_;  
  TH2F* fake_rate_ele_45EWKDown_; 
  ...
  float operator()(RVecI Lepton_pdgId,
    ...
    if (nLeptons_ == 2){
      ...
      // Calculate the per-event fake rate - EWKEleUp
      else if (kind_ == "EWKEleUp"){

		float fakeWeight_2l0jEWKEleUp = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												 fake_rate_ele_35EWKUp_, fake_rate_muon_20EWKUp_, "Nominal");

		float fakeWeight_2l1jEWKEleUp = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												 fake_rate_ele_30EWKUp_, fake_rate_muon_30EWKUp_, "Nominal");
		
		float fakeWeight_2l2jEWKEleUp = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												 fake_rate_ele_35EWKUp_, fake_rate_muon_35EWKUp_, "Nominal");
		
        float fakeWeightEWKEleUp = 0.;
        if (fakeWeight != 0.){

		  float num = fakeWeight_2l1jEWKEleUp;
		  
		  fakeWeightEWKEleUp = num / fakeWeight;
        }
        
        return fakeWeightEWKEleUp;
      }

      // Calculate the per-event fake rate - EWKEleDown
      else if (kind_ == "EWKEleDown"){

		float fakeWeight_2l0jEWKEleDown = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												   fake_rate_ele_35EWKDown_, fake_rate_muon_20EWKDown_, "Nominal");

		float fakeWeight_2l1jEWKEleDown = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												   fake_rate_ele_30EWKDown_, fake_rate_muon_30EWKDown_, "Nominal");
		
		float fakeWeight_2l2jEWKEleDown = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												   fake_rate_ele_35EWKDown_, fake_rate_muon_35EWKDown_, "Nominal");
		
        float fakeWeightEWKEleDown = 0.;
        if (fakeWeight != 0.){
		  
		  float num = fakeWeight_2l1jEWKEleDown;
		  
		  fakeWeightEWKEleDown = num / fakeWeight;
        }
        
        return fakeWeightEWKEleDown;
      }
	  
      // Calculate the per-event fake rate - EWKMuUp
      else if (kind_ == "EWKMuUp"){

		float fakeWeight_2l0jEWKMuUp = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												fake_rate_ele_35EWKUp_, fake_rate_muon_20EWKUp_, "Nominal");
		
		float fakeWeight_2l1jEWKMuUp = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												fake_rate_ele_30EWKUp_, fake_rate_muon_30EWKUp_, "Nominal");
		
		float fakeWeight_2l2jEWKMuUp = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												fake_rate_ele_35EWKUp_, fake_rate_muon_35EWKUp_, "Nominal");
		
        float fakeWeightEWKMuUp = 0.;
        if (fakeWeight != 0.){
		  
		  float num = fakeWeight_2l1jEWKMuUp;
		  
		  fakeWeightEWKMuUp = num / fakeWeight;
        }
        
        return fakeWeightEWKMuUp;
      }
	  
      // Calculate the per-event fake rate - EWKMuDown
      else if (kind_ == "EWKMuDown"){
		
		float fakeWeight_2l0jEWKMuDown = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												  Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												  fake_rate_ele_35EWKDown_, fake_rate_muon_20EWKDown_, "Nominal");
		
		float fakeWeight_2l1jEWKMuDown = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												  Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												  fake_rate_ele_30EWKDown_, fake_rate_muon_30EWKDown_, "Nominal");
		
		float fakeWeight_2l2jEWKMuDown = GetFR_2l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												  Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												  fake_rate_ele_35EWKDown_, fake_rate_muon_35EWKDown_, "Nominal");
		
        float fakeWeightEWKMuDown = 0.;
        if (fakeWeight != 0.){
		  
		  float num = fakeWeight_2l1jEWKMuDown;
		  
		  fakeWeightEWKMuDown = num / fakeWeight;
        }
        
        return fakeWeightEWKMuDown;
      }
      ...
      // Calculate the per-event fake rate - EWKEleUp
      if (kind_ == "EWKEleUp"){
		float fakeWeight_3lEWKEleUp = GetFR_3l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											   Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
											   Lepton_pt[2], Lepton_eta[2], Lepton_pdgId[2], isTight_[2],
											   fake_rate_ele_30EWKUp_, fake_rate_muon_30EWKUp_, "Nominal");
		
		float fakeWeightEWKEleUp = fakeWeight_3lEWKEleUp / fakeWeight_3l;
      ...
      // Calculate the per-event fake rate - EWKEleDown
      if (kind_ == "EWKEleDown"){
		float fakeWeight_3lEWKEleDown = GetFR_3l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												 Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												 Lepton_pt[2], Lepton_eta[2], Lepton_pdgId[2], isTight_[2],
												 fake_rate_ele_30EWKDown_, fake_rate_muon_30EWKDown_, "Nominal");
		
		float fakeWeightEWKEleDown = fakeWeight_3lEWKEleDown / fakeWeight_3l;
      ...
      // Calculate the per-event fake rate - EWKMuUp
      if (kind_ == "EWKMuUp"){
		float fakeWeight_3lEWKMuUp = GetFR_3l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
											  Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
											  Lepton_pt[2], Lepton_eta[2], Lepton_pdgId[2], isTight_[2],
											  fake_rate_ele_30EWKUp_, fake_rate_muon_30EWKUp_, "Nominal");
		
		float fakeWeightEWKMuUp = fakeWeight_3lEWKMuUp / fakeWeight_3l;
      ...
      // Calculate the per-event fake rate - EWKMuDown
      if (kind_ == "EWKMuDown"){
		float fakeWeight_3lEWKMuDown = GetFR_3l(Lepton_pt[0], Lepton_eta[0], Lepton_pdgId[0], isTight_[0],
												Lepton_pt[1], Lepton_eta[1], Lepton_pdgId[1], isTight_[1],
												Lepton_pt[2], Lepton_eta[2], Lepton_pdgId[2], isTight_[2],
												fake_rate_ele_30EWKDown_, fake_rate_muon_30EWKDown_, "Nominal");
		
		float fakeWeightEWKMuDown = fakeWeight_3lEWKMuDown / fakeWeight_3l;
		
		return fakeWeightEWKMuDown;
      }

      else{
		std::cout << "kind_ " << kind_ << " not known"<<std::endl;
		return -1;
      }
    }
...
fake_rate_reader::fake_rate_reader( TString year , TString ele_WP, TString muon_WP, float ele_WP_number, float muon_WP_number, TString kind, uint nLeptons, TString electron_tight_charge, TString mkShapesRDF_base ){
  ...
  std::cout << "Input files are in: " << fake_muon_file_name_10 << std::endl;
  ...
  fake_rate_muon_10EWKUp_   = (TH2F*) f_muon_10 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_10EWKDown_ = (TH2F*) f_muon_10 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_15          = new TFile(fake_muon_file_name_15);
  fake_rate_muon_15_        = (TH2F*) f_muon_15 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_15EWKUp_   = (TH2F*) f_muon_15 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_15EWKDown_ = (TH2F*) f_muon_15 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_20          = new TFile(fake_muon_file_name_20);
  fake_rate_muon_20_        = (TH2F*) f_muon_20 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_20EWKUp_   = (TH2F*) f_muon_20 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_20EWKDown_ = (TH2F*) f_muon_20 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_25          = new TFile(fake_muon_file_name_25);
  fake_rate_muon_25_        = (TH2F*) f_muon_25 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_25EWKUp_   = (TH2F*) f_muon_25 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_25EWKDown_ = (TH2F*) f_muon_25 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_30          = new TFile(fake_muon_file_name_30);
  fake_rate_muon_30_        = (TH2F*) f_muon_30 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_30EWKUp_   = (TH2F*) f_muon_30 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_30EWKDown_ = (TH2F*) f_muon_30 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_35          = new TFile(fake_muon_file_name_35);
  fake_rate_muon_35_        = (TH2F*) f_muon_35 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_35EWKUp_   = (TH2F*) f_muon_35 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_35EWKDown_ = (TH2F*) f_muon_35 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_40          = new TFile(fake_muon_file_name_40);
  fake_rate_muon_40_        = (TH2F*) f_muon_40 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_40EWKUp_   = (TH2F*) f_muon_40 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_40EWKDown_ = (TH2F*) f_muon_40 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_muon_45          = new TFile(fake_muon_file_name_45);
  fake_rate_muon_45_        = (TH2F*) f_muon_45 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_muon_45EWKUp_   = (TH2F*) f_muon_45 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_muon_45EWKDown_ = (TH2F*) f_muon_45 -> Get("FR_pT_eta_EWKcorr_EWK5Down");
  ...
  fake_rate_ele_20EWKUp_   = (TH2F*) f_ele_20 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_ele_20EWKDown_ = (TH2F*) f_ele_20 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_ele_25          = new TFile(fake_ele_file_name_25);
  fake_rate_ele_25_        = (TH2F*) f_ele_25 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_ele_25EWKUp_   = (TH2F*) f_ele_25 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_ele_25EWKDown_ = (TH2F*) f_ele_25 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_ele_30          = new TFile(fake_ele_file_name_30);
  fake_rate_ele_30_        = (TH2F*) f_ele_30 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_ele_30EWKUp_   = (TH2F*) f_ele_30 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_ele_30EWKDown_ = (TH2F*) f_ele_30 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_ele_35          = new TFile(fake_ele_file_name_35);
  fake_rate_ele_35_        = (TH2F*) f_ele_35 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_ele_35EWKUp_   = (TH2F*) f_ele_35 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_ele_35EWKDown_ = (TH2F*) f_ele_35 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_ele_40          = new TFile(fake_ele_file_name_40);
  fake_rate_ele_40_        = (TH2F*) f_ele_40 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_ele_40EWKUp_   = (TH2F*) f_ele_40 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_ele_40EWKDown_ = (TH2F*) f_ele_40 -> Get("FR_pT_eta_EWKcorr_EWK5Down");

  TFile* f_ele_45          = new TFile(fake_ele_file_name_45);
  fake_rate_ele_45_        = (TH2F*) f_ele_45 -> Get("FR_pT_eta_EWKcorr");
  fake_rate_ele_45EWKUp_   = (TH2F*) f_ele_45 -> Get("FR_pT_eta_EWKcorr_EWK5Up");
  fake_rate_ele_45EWKDown_ = (TH2F*) f_ele_45 -> Get("FR_pT_eta_EWKcorr_EWK5Down");
