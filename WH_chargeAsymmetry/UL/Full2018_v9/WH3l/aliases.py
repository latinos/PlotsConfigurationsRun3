...
aliases['fakeW'] = {
    ...
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"nominal\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWEleUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EleUp = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"EleUp\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWEleDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EleDown = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"EleDown\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWMuUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_MuUp = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"MuUp\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWMuDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_MuDown = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"MuDown\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWStatEleUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatEleUp = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"StatEleUp\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWStatEleDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatEleDown = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"StatEleDown\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWStatMuUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatMuUp = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"StatMuUp\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWStatMuDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatMuDown = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"StatMuDown\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWEWKEleUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EWKEleUp = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"EWKEleUp\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWEWKEleDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EWKEleDown = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"EWKEleDown\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWEWKMuUp'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EWKMuUp = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"EWKMuUp\", 3, \"std\", \"{configurations}\");')"],
...
aliases['fakeWEWKMuDown'] = {
    'linesToAdd'     : [f'#include "{configurations}/macros/fake_rate_reader_class.cc"'],
    'linesToProcess' : [f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EWKMuDown = fake_rate_reader(\"2018\", \"90\", \"82\", 0.90, 0.82, \"EWKMuDown\", 3, \"std\", \"{configurations}\");')"],
