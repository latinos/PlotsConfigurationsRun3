...
Select datacard to use and actually produce impact plots:
    ...
    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_SS_CR.root -m 125 --doInitialFit -t -1 --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A --freezeParameters r_higgs

    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_SS_CR.root -m 125 --doFits -t -1 --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A --job-mode condor --freezeParameters r_higgs --sub-opts='+JobFlavour="workday"'
...
Back to the singularity:
    ...
    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_SS_2016HIPM_v9_SS_CR.root -m 125 -t -1 -o impacts_WHSS_2016HIPM_binning.json --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A

    plotImpacts.py -i impacts_WHSS_2016HIPM_binning.json -o Impacts_WHSS_2016HIPM_binning
...
Copy the plots on the web:
    ...
    cp impacts_WHSS_2016HIPM_binning.json Impacts_WHSS_2016HIPM_binning.pdf /eos/user/n/ntrevisa/www/plots/${DATE}/2016HIPM/Impacts/