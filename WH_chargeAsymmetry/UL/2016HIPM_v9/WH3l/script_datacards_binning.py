...
for scale in scaling:
    ...
    tmp_command = "combineCards.py WH_3l_sssf_plus=datacards{4}/wh3l_13TeV_sssf_plus_pt2ge20/{0}/datacard.txt \
                                   ...
                                   > Combination/WH_chargeAsymmetry_WH_3l_2016HIPM_v9.txt".format(
                                       var_SSSF_plus,
                                       var_SSSF_minus,
                                       var_OSSF_plus,
                                       var_OSSF_minus,
...
# WH_2l_SS_CR_0j_plus=../datacards{4}/wh3l_13TeV_SS_CR_plus_pt2ge20/events/datacard.txt \
# WH_2l_SS_CR_0j_minus=../datacards{4}/wh3l_13TeV_SS_CR_minus_pt2ge20/events/datacard.txt \
