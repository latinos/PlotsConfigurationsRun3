...
cuts['hww2l2v_13TeV_WH_SS_WZ'] = {
    'expr' : '((Lepton_pdgId[0]*Lepton_pdgId[1] == 13*13) || (Lepton_pdgId[0]*Lepton_pdgId[1] == 11*13) || (Lepton_pdgId[0]*Lepton_pdgId[1] == 11*11)) && PuppiMET_pt > 45 && Alt(Lepton_pt,1,0)>20 && Alt(Lepton_pt,2,0)>15 && Alt(CleanJet_pt, 0, 0)>30 && WH3l_mlll > 100',
    'categories' : {
        ...
        '2j_plus'  : 'Alt(CleanJet_pt, 1, 0) >= 30 && Alt(CleanJet_pt, 2, 0) < 30 && Lepton_pdgId[0] < 0 && Lepton_pdgId[1] < 0',
        '2j_minus' : 'Alt(CleanJet_pt, 1, 0) >= 30 && Alt(CleanJet_pt, 2, 0) < 30 && Lepton_pdgId[0] > 0 && Lepton_pdgId[1] > 0',
    }
}
