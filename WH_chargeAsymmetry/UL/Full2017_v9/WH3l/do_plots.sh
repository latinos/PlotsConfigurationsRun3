...
if [ "$DATE" != "" ]; then
	...
	cp /eos/user/n/ntrevisa/mkShapesRDF_rootfiles/WH3l_2017_v9_chargeAsymmetry_Mu82_EleUL90/rootFile/mkShapes__WH3l_2017_v9_chargeAsymmetry_Mu82_EleUL90.root /eos/user/n/ntrevisa/www/plots/${DATE}/2017/
	echo "Done!"
fi
