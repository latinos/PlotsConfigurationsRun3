...
Select datacard to use and actually produce impact plots:
    ...
    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_3l_Full2017_v9.root -m 125 --doFits -t -1 --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A --job-mode condor --freezeParameters r_higgs --sub-opts='+JobFlavour="workday"'
...
Back to the singularity:
    ...
    combineTool.py -M Impacts -d ../Combination/WH_chargeAsymmetry_WH_3l_Full2017_v9.root -m 125 -t -1 -o impacts_WH3l_Full2017_binning.json --setParameters r_S=1.3693,r_A=0.224,r_higgs=1 --setParameterRanges r_S=0,10:r_A=-1,1 --redefineSignalPOIs r_A

    plotImpacts.py -i impacts_WH3l_Full2017_binning.json -o Impacts_WH3l_Full2017_binning
...
Copy the plots on the web:
    ...
    cp impacts_WH3l_Full2017_binning.json Impacts_WH3l_Full2017_binning.pdf /eos/user/n/ntrevisa/www/plots/${DATE}/2017/Impacts/
