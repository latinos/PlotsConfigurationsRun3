...
#     'name'    : 'CMS_WH_hww_fake_syst_2j_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_ee' : '1.3',
...
#     'name'    : 'CMS_WH_hww_fake_syst_1j_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_ee' : '1.3',
...
nuisances['fake_syst_ee_2j'] = {
    'name'    : 'CMS_WH_hww_fake_syst_ee_2j_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : {
        'Fake_ee' : '1.3',
...
# nuisances['fake_syst_ee_2j_minus'] = {
#     'name'    : 'CMS_WH_hww_fake_syst_ee_2j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_ee' : '1.3',
...
nuisances['fake_syst_em_2j'] = {
    'name'    : 'CMS_WH_hww_fake_syst_em_2j_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : {
        'Fake_em' : '1.3',
...
# nuisances['fake_syst_em_2j_minus'] = {
#     'name'    : 'CMS_WH_hww_fake_syst_em_2j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_em' : '1.3',
...
nuisances['fake_syst_mm_2j'] = {
    'name'    : 'CMS_WH_hww_fake_syst_mm_2j_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : {
        'Fake_mm' : '1.3',
...
# nuisances['fake_syst_mm_2j_minus'] = {
#     'name'    : 'CMS_WH_hww_fake_syst_mm_2j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_mm' : '1.3',
...
nuisances['fake_syst_ee_1j'] = {
    'name'    : 'CMS_WH_hww_fake_syst_ee_1j_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : {
        'Fake_ee' : '1.3',
...
# nuisances['fake_syst_ee_1j_minus'] = {
#     'name'    : 'CMS_WH_hww_fake_syst_ee_1j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_ee' : '1.3',
...
nuisances['fake_syst_em_1j'] = {
    'name'    : 'CMS_WH_hww_fake_syst_em_1j_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : {
        'Fake_em' : '1.3',
...
# nuisances['fake_syst_em_1j_minus'] = {
#     'name'    : 'CMS_WH_hww_fake_syst_em_1j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_em' : '1.3',
...
nuisances['fake_syst_mm_1j'] = {
    'name'    : 'CMS_WH_hww_fake_syst_mm_1j_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : {
        'Fake_mm' : '1.3',
...
# nuisances['fake_syst_mm_1j_minus'] = {
#     'name'    : 'CMS_WH_hww_fake_syst_mm_1j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : {
#         'Fake_mm' : '1.3',
...
#     'name'    : 'CMS_WH_hww_charge_2j_plus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
...
#     'name'    : 'CMS_WH_hww_charge_2j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#      'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_1j_plus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#      'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_1j_minus_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#      'cuts' : [
...
nuisances['charge_2j_plus_ee'] = {
    'name'    : 'CMS_WH_hww_charge_2j_plus_ee_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
    'cuts' : [
...
nuisances['charge_2j_plus_em'] = {
    'name'    : 'CMS_WH_hww_charge_2j_plus_em_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
    'cuts' : [
...
nuisances['charge_2j_plus_mm'] = {
    'name'    : 'CMS_WH_hww_charge_2j_plus_mm_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
    'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_2j_minus_ee_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#     'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_2j_minus_em_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#     'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_2j_minus_mm_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#     'cuts' : [
...
nuisances['charge_1j_plus_ee'] = {
    'name'    : 'CMS_WH_hww_charge_1j_plus_ee_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
    'cuts' : [
...
nuisances['charge_1j_plus_em'] = {
    'name'    : 'CMS_WH_hww_charge_1j_plus_em_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
    'cuts' : [
...
nuisances['charge_1j_plus_mm'] = {
    'name'    : 'CMS_WH_hww_charge_1j_plus_mm_2017',
    'kind'    : 'weight',
    'type'    : 'lnN',
    'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
    'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_1j_minus_ee_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#     'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_1j_minus_em_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#     'cuts' : [
...
#     'name'    : 'CMS_WH_hww_charge_1j_minus_mm_2017',
#     'kind'    : 'weight',
#     'type'    : 'lnN',
#     'samples' : dict((skey, '1.10') for skey in samples if skey not in ['DATA']),
#     'cuts' : [
