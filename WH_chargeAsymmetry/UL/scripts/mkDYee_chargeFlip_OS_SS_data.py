...
# Function to dynamically import 'dict_os_ss_cuts'
def import_dictionary(file_name):
    module_name = 'dict_os_ss_cuts'
    spec = importlib.util.spec_from_file_location(module_name, file_name)
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    return getattr(module, 'dict_os_ss_cuts', None)
...
if __name__ == '__main__':
    ...
    if os.path.exists(opt.os_ss_cutsFile) :
      file_name_no_py = opt.os_ss_cutsFile
      dict_os_ss_cuts = import_dictionary(file_name_no_py)
      # print("Dictionary: {}".format(dict_os_ss_cuts))
