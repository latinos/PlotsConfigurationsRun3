...
btv_path =  '/afs/cern.ch/work/b/bcamaian/mkShapesRDF_el9/mkShapesRDF/processor/data/jsonpog-integration/POG/BTV/2017_UL'
...
for flavour in ['bc', 'light']:
    for shift in ['central', 'up_uncorrelated', 'down_uncorrelated', 'up_correlated', 'down_correlated']:
        ...
        if shift != 'central':
            btagsf += '_' + shift
        aliases[btagsf] = {
            'linesToAdd': [f'#include "{configurations}/macros/evaluate_btagSF{flavour}_2017.cc"'],
            'linesToProcess': [f"ROOT.gInterpreter.Declare('btagSF{flavour} btagSF{flavour}_{shift} = btagSF{flavour}(\"{btv_path}/bTagEff_2017_ttbar_DeepFlavB_loose.root\");')"],
