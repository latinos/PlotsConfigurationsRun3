...
nuisances['PU'] = {
    ...
    'type': 'shape',
    'samples': {
        'dytt'      : ['1.001301*(puWeightUp/puWeight)', '1.000343*(puWeightDown/puWeight)'],
...
nuisances['PU']['samples'].update(dict((skey, ['1.006784*(puWeightUp/puWeight)', '0.993494*(puWeightDown/puWeight)']) for skey in mc if 'ggH_hww' in skey))
nuisances['PU']['samples'].update(dict((skey, ['1.006784*(puWeightUp/puWeight)', '0.993494*(puWeightDown/puWeight)']) for skey in mc if 'qqH_hww' in skey))
