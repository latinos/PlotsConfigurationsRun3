...
ttHMVASF::ttHMVASF( const char* year, const int nLeptons, const char* muOrEle, std::string requested_SF ) {
  ...
  SF_files_map["electron"]["2016HIPM"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/electron/2016HIPM/egammaEffi.txt"
  };
  SF_files_map["electron"]["2016noHIPM"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/electron/2016noHIPM/egammaEffi.txt"
  };
  SF_files_map["electron"]["2017"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/electron/2017/egammaEffi.txt"
  };
  SF_files_map["electron"]["2018"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/electron/2018/egammaEffi.txt"
  };

  // Muon
  SF_files_map["muon"]["2016HIPM"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/muon/2016HIPM/NUM_TightHWW_ISO_tthmva_DEN_TightHWW_ISO_eta_pt.root"
  };
  SF_files_map["muon"]["2016noHIPM"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/muon/2016noHIPM/NUM_TightHWW_ISO_tthmva_DEN_TightHWW_ISO_eta_pt.root"
  };
  SF_files_map["muon"]["2017"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/muon/2017/NUM_TightHWW_ISO_tthmva_DEN_TightHWW_ISO_eta_pt.root"
  };
  SF_files_map["muon"]["2018"] = {
	mkShapesRDF_base + "/VBF_differential/ttHMVA_UL_SF/muon/2018/NUM_TightHWW_ISO_tthmva_DEN_TightHWW_ISO_eta_pt.root"
  };
