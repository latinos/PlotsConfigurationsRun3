...
#include "/afs/cern.ch/work/b/bcamaian/mkShapesRDF/JHUGenMELA/MELA/interface/Mela.h"
...
class MEMELA{
 public:
  ...
  //  RVecF operator()(float _nCleanJet, float _nLepton, float _PuppiMet_pt, float _PuppiMet_phi,
  //         float _Lepton_pt0, float _Lepton_pt1, float _Lepton_phi0, float _Lepton_phi1, float _Lepton_eta0, float _Lepton_eta1,
  //         float _CleanJet_pt0, float _CleanJet_pt1, float _CleanJet_phi0, float _CleanJet_phi1, float _CleanJet_eta0, float _CleanJet_eta1,
  //         int _Lepton_pdgId0, int _Lepton_pdgId1 ) {
      ...
      //  Lepton_pt0=_Lepton_pt0; Lepton_pt1=_Lepton_pt1;
      //  Lepton_phi0=_Lepton_phi0; Lepton_phi1=_Lepton_phi1; Lepton_eta0=_Lepton_eta0; Lepton_eta1=_Lepton_eta1;
      //  CleanJet_pt0=_CleanJet_pt0; CleanJet_pt1=_CleanJet_pt1; CleanJet_phi0=_CleanJet_phi0; CleanJet_phi1=_CleanJet_phi1; CleanJet_eta0=_CleanJet_eta0; CleanJet_eta1=_CleanJet_eta1;
      //  Lepton_pdgId0=_Lepton_pdgId0; Lepton_pdgId1=_Lepton_pdgId1;
       ...
       if(nCleanJet >= 2 && nLepton > 1){
        ...
        //  if (Lepton_pdgId0*Lepton_pdgId1  != -11*13) {
           me = {-9999., -9999., -9999.};
