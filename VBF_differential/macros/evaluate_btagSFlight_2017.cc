...
btagSFlight::btagSFlight(TString eff_map) {
  cset = CorrectionSet::from_file("/afs/cern.ch/work/b/bcamaian/mkShapesRDF_el7/mkShapesRDF/processor/data/jsonpog-integration/POG/BTV/2017_UL/btagging.json.gz");
