...
def getSampleFilesNano(inputDir,Sample,absPath=False):
    ...
    return nanoGetSampleFiles(inputDir, Sample) # getSampleFiles replaced with nanoGetSampleFiles(path, name) (DS, 03Nov25)
...
M10baseW   = '1'#CombineBaseW(directory,'Autumn18_102X_nAODv7_Full2018v7',['DYJetsToLL_M-10to50-LO','DYJetsToLL_M-10to50-LO_ext1'])
...
ZZ2LbaseW   = '1'#CombineBaseW(directory,'Autumn18_102X_nAODv7_Full2018v7',['ZZTo2L2Nu_ext1','ZZTo2L2Nu_ext2'])
ZZ4LbaseW   = '1'#CombineBaseW(directory,'Autumn18_102X_nAODv7_Full2018v7',['ZZTo4L_ext1',   'ZZTo4L_ext2'])
