...
for flavour in ['bc', 'light']:
    ...
    aliases[btagsf_tmp] = {
        'linesToProcess':[
            ...
            f"ROOT.gInterpreter.Declare('btagSF{flavour} btag_SF{flavour} = btagSF{flavour}(\"/afs/cern.ch/work/s/sblancof/private/Run2Analysis/sendEOSJobs/Full2018_v9/BtagEff/bTagEff_2018_ttbar_DeepFlavB_loose.root\",\"{year}\");')"
        ],
