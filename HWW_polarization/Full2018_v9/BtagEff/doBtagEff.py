...
path_2018 = "/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer20UL18_106x_nAODv9_Full2018v9/MCl1loose2018v9__MCCorr2018v9NoJERInHorn__l2tightOR2018v9/nanoLatino_GluGluHToWWTo2L2Nu_M125__part*.root"

cmd = "find {}".format(path_2018)
...
df_ak.to_csv("ggh_2018_cleanjet.csv")
print("Saved!!")
...
file = ROOT.TFile(f"bTagEff_{year}_ggh_DeepFlavB_loose.root", "RECREATE")
file.cd()
