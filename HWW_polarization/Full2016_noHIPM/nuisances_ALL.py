...
nuisances['PU'] = {
    ...
    'samples' : {
        ...
        'ggWW_si'    : ['1.006460*(puWeightUp/puWeight)', '0.993661*(puWeightDown/puWeight)'],
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_ss_Inc'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.6918910629465432*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_ss_1j'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.6722224796886095*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_0j_pt2gt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.24852257625983765*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_0j_pt2lt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.1599841484290069*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_1j_pt2gt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.23917784903369915*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_1j_pt2lt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.1765795125780062*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_2j_tot'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.24399467754525517*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_2j'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.1921671792967825*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_RF02_2j_vbf'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.34467130865533024*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_0j_pt2lt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.2861139923128507*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_1j_pt2gt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.6261476280832211*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_sr_1j_pt2lt20'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.3572999735604609*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_top_2j'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.5327864140874823*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_dytt_1j'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.4841436993700698*(1.15-1.0))
    },
...
nuisances['QCDscale_ggVV_hww2l2v_13TeV_dytt_2j'] = {
    ...
    'type': 'lnN',
    'samples': {
        'ggToWW': str(1+0.4320602960225519*(1.15-1.0))
    },
