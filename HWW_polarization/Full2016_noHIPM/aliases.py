...
aliases['LepWPttHMVASF_tot'] = {
    ...
    'linesToProcess':["""ROOT.gInterpreter.Declare('ttHMVASF tth_sf("2016noHIPM", "all");')"""],
...
aliases['CleanJet_VetoMap'] = {
    'linesToAdd': [
        ...
        'string path_file = "/afs/cern.ch/work/s/sblancof/private/Run2Analysis/AlmaLinux9_mkShapes/mkShapesRDF/examples/Full2016_noHIPM/jetvetomaps.json";',
        ...
        '#include "/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/jet_veto_2016preVFP.cc"',
    ],
    'expr': "Jet_Veto(CleanJet_pt,CleanJet_eta,CleanJet_phi,Jet_neEmEF,Jet_chEmEF,CleanJet_jetIdx)"
    # Old - inefficient
    # 'linesToAdd': [".L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/jet_veto_2016preVFP.cc+"],
    # 'class' : 'Jet_Veto',
...
aliases['fakeW'] = {
    ...
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"nominal\", 2, \"std\");')"],
...
aliases['fakeWEleUp'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EleUp = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"EleUp\", 2, \"std\");')"],
...
aliases['fakeWEleDown'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_EleDown = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"EleDown\", 2, \"std\");')"],
...
aliases['fakeWMuUp'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_MuUp = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"MuUp\", 2, \"std\");')"],
...
aliases['fakeWMuDown'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_MuDown = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"MuDown\", 2, \"std\");')"],
...
aliases['fakeWStatEleUp'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatEleUp = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"StatEleUp\", 2, \"std\");')"],
...
aliases['fakeWStatEleDown'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatEleDown = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"StatEleDown\", 2, \"std\");')"],
...
aliases['fakeWStatMuUp'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatMuUp = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"StatMuUp\", 2, \"std\");')"],
...
aliases['fakeWStatMuDown'] = {
    'linesToAdd' : ['#include "/eos/user/s/sblancof/Run2Analysis/mkShapesRDF/examples/extended/fake_rate_reader_class.cc"'],
    'linesToProcess':["ROOT.gInterpreter.Declare('fake_rate_reader fr_reader_StatMuDown = fake_rate_reader(\"2016_noHIPM\", \"90\", \"82\", 0.90, 0.82, \"StatMuDown\", 2, \"std\");')"],
...
aliases['RandomForest_evaluator'] = {    
    'linesToProcess' : [
        ...
        """ROOT.gInterpreter.Declare('EvaluateRF rf_evaluator("2016_noHIPM");')"""
    ],
