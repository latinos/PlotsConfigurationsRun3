...
#ifndef jet_veto_2017
#define jet_veto_2017
...
int Jet_Veto(
  ...
  string path_file = "/afs/cern.ch/work/s/sblancof/private/Run2Analysis/AlmaLinux9_mkShapes/mkShapesRDF/examples/Full2017_v9/jetvetomaps.json";
