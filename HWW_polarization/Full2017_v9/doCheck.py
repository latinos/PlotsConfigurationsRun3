...
def run(submit=False, onlySample=None):
    ...
    for fname in fnames:
        ...
        file_name = output_path + "/mkShapes__WW_2017_complete__ALL__" + fname + ".root"
...
transfer_input_files = $(Folder)/script.py, /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/mkShapesRDF/include/headers.hh, /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/mkShapesRDF/shapeAnalysis/runner.py, /afs/cern.ch/work/s/sblancof/private/Run2Analysis/AlmaLinux9_mkShapes/mkShapesRDF/examples/Full2018_v9/NNLOPS_reweight.root,/afs/cern.ch/work/s/sblancof/private/Run2Analysis/AlmaLinux9_mkShapes/mkShapesRDF/examples/Full2017_v9/jetvetomaps.json,/afs/cern.ch/work/s/sblancof/private/Run2Analysis/sendEOSJobs/jsonpog-integration/POG/BTV/2017_UL/btagging.json.gz,/afs/cern.ch/work/s/sblancof/private/Run2Analysis/sendEOSJobs/Full2017_v9/BtagEff/bTagEff_2017_ttbar_DeepFlavB_loose.root
