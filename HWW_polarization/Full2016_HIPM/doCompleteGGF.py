...
df2 = uproot.open("/eos/user/s/sblancof/MC/rootFiles/mkShapes__WW_2016__ALL__ggH_gWW_Int.root")
print("\n")
...
for cutName in cuts:
    ...
    for varName in variables:
        ...
        inFile = ROOT.TFile("/eos/user/s/sblancof/MC/rootFiles/mkShapes__WW_2016__ALL__ggH_gWW_Int.root")
