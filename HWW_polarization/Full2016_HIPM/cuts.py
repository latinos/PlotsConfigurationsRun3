...
cuts['hww2l2v_13TeV_ss'] = {
    'expr': 'bVeto && mll > 12 && Lepton_pdgId[0]*Lepton_pdgId[1] == 11*13',
    'categories' : {
        'Inc': 'mll>12 && mth>40 && PuppiMET_pt>20',
        '0j' : 'Alt(CleanJet_pt,0, 0.0)<30.0 && mth>40 && PuppiMET_pt>20',
        '1j' : 'Alt(CleanJet_pt,0, 0.0)>30.0 && Alt(CleanJet_pt,1, 0.0)<30.0 && mth>40 && PuppiMET_pt>20',
        '2j' : 'Sum(CleanJet_pt>30.0)==2 && mth>40 && PuppiMET_pt>20',
    }
}
