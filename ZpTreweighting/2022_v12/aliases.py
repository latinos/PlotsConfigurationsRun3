...
aliases['DY_NLO_ZpTrw'] = {
    'expr': '(' + DYrew['2022']['NLO_0j'].replace('x', 'gen_Zpt') + ')*(zeroJet)' +
            ' + (' + DYrew['2022']['NLO_1j'].replace('x', 'gen_Zpt') + ')*(oneJet&& Alt(CleanJet_pt,1,0)<30)' +
            ' + (' + DYrew['2022']['NLO_2j'].replace('x', 'gen_Zpt') + ')*(multiJet)',
    'samples': ['DY']
}
