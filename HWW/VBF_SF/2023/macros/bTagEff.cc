...
dataset mkDataset(int year) {
  ...
  else if (year == 2023) 
  {
    ...
    d.algo = 
    {
        {"DeepFlavB", {{"loose" , 0.0479}, {"medium" , 0.3086}, {"tight" , 0.7183}}},
        {"RobustParTAK4B", {{"loose", 0.0849}, {"medium", 0.4319}, {"tight", 0.8482}}},
        {"PNetB", {{"loose", 0.0470}, {"medium", 0.2450}, {"tight", 0.6734}}}
    };
  }
  else if (year == 20232) 
  {
    ...
    d.algo = 
    {
        {"DeepFlavB", {{"loose" , 0.0480}, {"medium" , 0.3086}, {"tight" , 0.7183}}},
        {"RobustParTAK4B", {{"loose", 0.0849}, {"medium", 0.4319}, {"tight", 0.8482}}},
        {"PNetB", {{"loose", 0.0470}, {"medium", 0.2450}, {"tight", 0.6734}}}
    };
  }
...
void bTagEff(int year, std::string process, std::string algo, std::string const WP) 
{
    ...
    TH1::SetDefaultSumw2(true);  
    TString fname   = "btag_2023BPix/bTagEff_" + std::to_string(year) + "_" + process + "_" + algo + "_" + WP + ".root";
    std::filesystem::create_directories("btag_2023BPix/efficiencies");
    ...
    */
    ...
    //gPad->SetLogX();
    TString cname = "btag_2023BPix/efficiencies/bjet_eff_" + std::to_string(year) + "_" + process + "_" + algo + "_" + WP + ".png";
    c->SaveAs(cname);
    bjet_eff->Write();
    ...
    cname = "btag_2023BPix/efficiencies/cjet_eff_" + std::to_string(year) + "_" + process + "_" + algo + "_" + WP + ".png";
    c->SaveAs(cname);
    cjet_eff->Write();
    ...
    cname = "btag_2023BPix/efficiencies/ljet_eff_" + std::to_string(year) + "_"  + process + "_" + algo + "_" + WP + ".png";
    c->SaveAs(cname);
    ljet_eff->Write();
