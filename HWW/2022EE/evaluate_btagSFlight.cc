...
btagSFlight::btagSFlight(TString eff_map) {
  cset = CorrectionSet::from_file("/afs/cern.ch/user/s/squinto/mkShapesRDF/mkShapesRDF/processor/data/jsonpog-integration/POG/BTV/2022_Summer22EE/btagging.json.gz");
