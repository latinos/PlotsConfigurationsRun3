...
####### jeteta1
        ...
        'jeteta1_relsample_up' : 'Alt(CleanJet_eta_jesRegroed_RelativeSample_2024up, 0, -99)',
        'jeteta1_relsample_down' : 'Alt(CleanJet_eta_jesRegroed_RelativeSample_2024do, 0, -99)',
...
#        'jeteta1_flavor_up' : 'Alt(CleanJet_eta_jesRegroed_FlavorQCDup, 0, -99)',
#        'jeteta1_flavor_down' : 'Alt(CleanJet_eta_jesRegroed_FlavorQCDdo, 0, -99)',
####### jeteta2
        'jeteta2' : 'Alt(CleanJet_eta, 1, -99)',
        'jeteta2_relsample_up' : 'Alt(CleanJet_eta_jesRegroed_RelativeSample_2024up, 1, -99)',
        'jeteta2_relsample_down' : 'Alt(CleanJet_eta_jesRegroed_RelativeSample_2024do, 1, -99)',
...
#        'jeteta2_flavor_up' : 'Alt(CleanJet_eta_jesRegroed_FlavorQCDup, 1, -99)',
#        'jeteta2_flavor_down' : 'Alt(CleanJet_eta_jesRegroed_FlavorQCDdo, 1, -99)',
####### jetpt1
        'jetpt1' : 'Alt(CleanJet_pt, 0, -99)',
        'jetpt1_relsample_up' : 'Alt(CleanJet_pt_jesRegroed_RelativeSample_2024up, 0, -99)',
        'jetpt1_relsample_down' : 'Alt(CleanJet_pt_jesRegroed_RelativeSample_2024do, 0, -99)',
...
#        'jetpt1_flavor_up' : 'Alt(CleanJet_pt_jesRegroed_FlavorQCDup, 0, -99)',
#        'jetpt1_flavor_down' : 'Alt(CleanJet_pt_jesRegroed_FlavorQCDdo, 0, -99)',
####### jetpt2
        'jetpt2' : 'Alt(CleanJet_pt, 1, -99)',
        'jetpt2_relsample_up' : 'Alt(CleanJet_pt_jesRegroed_RelativeSample_2024up, 1, -99)',
        'jetpt2_relsample_down' : 'Alt(CleanJet_pt_jesRegroed_RelativeSample_2024do, 1, -99)',
...
#        'jetpt2_flavor_up' : 'Alt(CleanJet_pt_jesRegroed_FlavorQCDup, 1, -99)',
#        'jetpt2_flavor_down' : 'Alt(CleanJet_pt_jesRegroed_FlavorQCDdo, 1, -99)',
####### dphillmet
        'dphillmet' : 'dphillmet',
...
######## mlj11
#        'mlj11' : 'm_lj[0]',
        #'mlj11_relsample_up' : 'm_lj11_jesRegroed_RelativeSample_2024up[0]',
        #'mlj11_relsample_down' : 'm_lj11_jesRegroed_RelativeSample_2024do[0]',
######## mlj12
#        'mlj12' : 'm_lj[1]',
        #'mlj12_relsample_up' : 'm_lj12_jesRegroed_RelativeSample_2024up[1]',
        #'mlj12_relsample_down' : 'm_lj12_jesRegroed_RelativeSample_2024do[1]',
######## mlj21
#        'mlj21' : 'm_lj[2]',
        #'mlj21_relsample_up' : 'm_lj21_jesRegroed_RelativeSample_2024up[2]',
        #'mlj21_relsample_down' : 'm_lj21_jesRegroed_RelativeSample_2024do[2]',
######## mlj22
#        'mlj22' : 'm_lj[3]',
        #'mlj22_relsample_up' : 'm_lj22_jesRegroed_RelativeSample_2024up[3]',
        #'mlj22_relsample_down' : 'm_lj22_jesRegroed_RelativeSample_2024do[3]',
####### mtw2
        'mtw2' : 'mtw2',
        'mtw2_relsample_up' : 'mtw2_jesRegroed_RelativeSample_2024up',
        'mtw2_relsample_down' : 'mtw2_jesRegroed_RelativeSample_2024do',
######### weights
#        'PS_ISR_d' : 'PSWeight[2]',
#        'PS_ISR_u' : 'PSWeight[0]',
#        'PS_FSR_d' : 'PSWeight[3]',
