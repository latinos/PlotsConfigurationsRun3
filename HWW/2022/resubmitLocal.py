...
resubmitLine = "queue 1 Folder in DY_7 WW_1"
condorFolder = 'condor/JetScaling_TopCR_2022_fixedWP_RobustParTAK4B'
...
for sample in samples:
    ...
    fSh += f'cp /afs/cern.ch/user/s/squinto/mkShapesRDF/mkShapesRDF/shapeAnalysis/runner.py . \n'
