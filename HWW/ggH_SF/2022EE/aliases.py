...
aliases['fakeW'] = {
    ...
    'linesToProcess':[f"ROOT.gInterpreter.Declare('fake_rate_reader fr_reader = fake_rate_reader(\"2022EE\", \"{eleWP}\", \"{muWP}\", 0.90, 0.80, \"nominal\", 2, \"std\", \"{configurations}\");')"],
...
eff_map_year = '20222' # ['2022', '20222', '2023', '20232']
